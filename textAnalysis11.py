...
#The top 10 users who have tweeted the most for the entire timeline.
def mostUsers():
    ...
    outputFile = open('D:/UNCC_Spring2018/ITIS6112/Week06/MostUsers.txt', 'w', encoding = "utf-8")
...
def mostUsersPerHour():
    ...
    outputFile = open('D:/UNCC_Spring2018/ITIS6112/Week06/MostUsersPerHour.txt', 'w', encoding = 'utf-8')
...
def maxFollowers():
    ...
    l = sorted(l.items(), key = operator.itemgetter(1), reverse = True)
    outputFile = open('D:/UNCC_Spring2018/ITIS6112/Week06/MaxFollowers.txt', 'w', encoding = "utf-8")
    outputFile.write("The top 10 users with the maximum followers: " + "\n\n")
...
def maxRetweet():
    ...
    outputFile = open('D:/UNCC_Spring2018/ITIS6112/Week06/MaxRetweets.txt', 'w', encoding = "utf-8")
    l = sorted(l.items(), key = operator.itemgetter(1), reverse = True)
    outputFile.write("The top 10 tweets with the maximum number of retweets : " +"\n\n")
